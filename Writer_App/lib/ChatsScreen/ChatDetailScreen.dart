...
class _ChatdetailscreenState extends State<Chatdetailscreen> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Start the conversation for this order. Keep all discussion order-specific.",
  ...
  Future<void> sendMessage() async {
    ...
    final String? currentWriterFirebaseUid = user?.uid;
    final String? userFirebaseUid = widget.order.userFirebaseUid;

    if (user == null ||
        currentWriterFirebaseUid == null ||
    ...
    final String clientMessageId =
        "msg_${DateTime.now().microsecondsSinceEpoch}_$currentWriterFirebaseUid";
    ...
    setState(() {
      pendingMessages.insert(0, {
        ...
        "message": message,
        "senderId": "WRITER_$currentWriterFirebaseUid",
        "receiverId": "USER_$userFirebaseUid",
        "senderFirebaseUid": currentWriterFirebaseUid,
    ...
    try {
      ...
      debugPrint("WRITER CHAT SEND URL: $url");
      debugPrint("WRITER CHAT ORDER ID: $orderId");
      debugPrint("WRITER CHAT RECEIVER USER UID: $userFirebaseUid");
      debugPrint("WRITER CHAT CLIENT MESSAGE ID: $clientMessageId");
      debugPrint("WRITER CHAT REQUEST BODY: ${jsonEncode(requestBody)}");
