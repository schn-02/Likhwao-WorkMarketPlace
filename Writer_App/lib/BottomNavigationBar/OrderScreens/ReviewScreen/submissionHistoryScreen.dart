...
class _submissionHistoryScreenState extends State<submissionHistoryScreen> {
  ...
  Future<String?> getWriterFileSignedUrlByPath({
    ...
    final url =
        "${apiConfig.baseUrl}/api/user_side/$orderId/writer-file-url-by-path?filePath=$encodedPath";

    print("SIGNED URL BY PATH API: $url");
    ...
    print("SIGNED URL BY PATH STATUS: ${response.statusCode}");
    print("SIGNED URL BY PATH BODY: ${response.body}");
