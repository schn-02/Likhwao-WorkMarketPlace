...
import 'package:likho/DeviceIdHelper/DeviceIdHelper.dart';
import 'package:likho/Model/AuthModel.dart';
...
class _AuthbackendState extends State<Authbackend> {
  ...
  //spring ko get hua data send ho rha hai model to json ke format me
  Future<void> sendToBackend(
    ...
    final url = Uri.parse(
      "${apiConfig.baseUrl}/api/writer_side/auth/SaveWriterDetails",
    );
