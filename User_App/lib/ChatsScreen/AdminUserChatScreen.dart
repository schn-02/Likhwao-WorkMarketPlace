...
class _AdminUserChatScreenState extends State<AdminUserChatScreen> {
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Icon(Icons.verified_rounded, color: purpleColor, size: 15),
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            // ✅ FIX: USER ka message RIGHT, ADMIN ka message LEFT
            final bool isCurrentUser = senderId.startsWith("USER_");
            ...
            final Widget bubble = isCurrentUser
  ...
  /// USER ka message — RIGHT side, purple (sent)
  ...
  /// ADMIN ka message — LEFT side, white (received)
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Admin will reach out if needed.",
  ...
  Future<void> _sendMessage() async {
    ...
    final String adminFirebaseUid = widget.userFirebaseUid; // admin uid passed here
    ...
    final String clientMessageId =
        "msg_${DateTime.now().microsecondsSinceEpoch}_$userUid";
    ...
    setState(() {
      pendingMessages.insert(0, {
        ...
        "message": message,
        "senderId": "USER_$userUid",
        "receiverId": "ADMIN_SUPPORT",
        "senderFirebaseUid": userUid,
        "receiverFirebaseUid": adminFirebaseUid,
        "timestamp": now,
        "isPending": true,
        "isRead": false,
      });
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        debugPrint("User→Admin message sent successfully");
        return;
      }
  ...
  Stream<QuerySnapshot> _getMessagesStream() {
    ...
    final String chatId = "ADMIN_USER_${widget.orderId}";
  ...
  Future<void> _markMessagesAsRead(List<QueryDocumentSnapshot> docs) async {
    ...
    final String currentId = "USER_$userUid";
    ...
    try {
      await batch.commit();
      debugPrint("User marked $count admin messages as read");
    } catch (e) {
